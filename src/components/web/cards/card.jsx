      ...
      <div className="flex flex-col text-center md:text-left">
        ...
        {props.show_btn && (
          <div className="flex justify-center md:justify-start gap-4">
            ...
            <button className="border border-black text-black px-4 py-2 text-sm md:text-base rounded 
            transition-all duration-200 hover:bg-black hover:text-white" onClick={
              ()=>navigate('/collection')
          }>
...
export function Rent_Card({ item }) {
  return (
    <div className="relative h-64 mt-0 w-full border shadow-md sm:h-72 md:h-80 lg:h-96 cursor-pointer" style={{ backgroundImage: `url(${item.img_url})` }}>
