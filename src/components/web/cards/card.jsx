  ...
  return (
    <div className="flex flex-col mt-0 w-[80vw] m-auto md:flex-row items-center gap-6 md:gap-10 bg-white px-4 md:px-16 py-10">
      ...
      <div className="flex flex-col text-center md:text-left">
        <h1 className="text-6xl md:text-5xl font-bold mb-4 justify-space">Rent Your Dream 
...
export function Party_Card({item}) {
  return (
    <div className="container mx-auto flex flex-col gap-4 overflow-hidden bg-white text-black px-4 sm:px-6 sm:py-16 md:py-20 lg:w-4/5 lg:flex-row lg:gap-4 lg:py-24">{/* style={{flexDirection:item.reverse?"row-reverse":""}}*/}
